...
package com.example.myterminalemulator.shortcuts;
...
import com.example.myterminalemulator.R;
import com.example.myterminalemulator.RemoteInterface;
import com.example.myterminalemulator.RunShortcut;
import com.example.myterminalemulator.TermDebug;
import com.example.myterminalemulator.compat.AlertDialogCompat;
import com.example.myterminalemulator.compat.PRNGFixes;
import com.example.myterminalemulator.util.ShortcutEncryption;
       ...
       extends    android.app.Activity
{
  ...
  void makeShortcut()
  {
              ...
              new View.OnClickListener()
              {
                public void onClick(View p1)
                {
                  ...
                  File get= (lastPath==null)
                    ...
                    {
                      pickerIntent.setClass(getApplicationContext(), com.example.myterminalemulator.shortcuts.FSNavigator.class)
    ...
    final ImageView img=new ImageView(context);
                    img.setImageResource(com.example.myterminalemulator.R.drawable.ic_launcher);
    ...
    )
    {
      ...
      Intent wrapper= new Intent();
             ...
             else
             {
               ...
               , Intent.ShortcutIconResource.fromContext(context, com.example.myterminalemulator.R.drawable.ic_launcher)
               );
             }
