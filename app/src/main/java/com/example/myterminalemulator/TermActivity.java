...
import com.example.myterminalemulator.compat.ActivityCompat;
import com.example.myterminalemulator.compat.AndroidCompat;
import com.example.myterminalemulator.compat.MenuItemCompat;
...
import com.example.myterminalemulator.emulatorview.UpdateCallback;
            ...
            if (AndroidCompat.V11ToV20) {
                switch (actionBarMode) {
                    case TermSettings.ACTION_BAR_MODE_ALWAYS_VISIBLE:
                        setTheme(R.style.AppTheme);  //  2020年2月2日16:36:08
                        break;
                    case TermSettings.ACTION_BAR_MODE_HIDES:
                        setTheme(R.style.ThemeOverlay_AppCompat_ActionBar);  // 2020年2月2日16:36:16
                        break;
                }
            }
        } else {
